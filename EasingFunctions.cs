...
namespace VisualEffects
{
    ...
    public class EasingFunctions
    {
        ...
        {
            return Math.Abs(currentTime - duration) < double.Epsilon ? minHeight + maxHeight : maxHeight * (-Math.Pow(2, -10 * currentTime / duration) + 1) + minHeight;
        }
        ...
        {
            return Math.Abs(currentTime) < double.Epsilon ? minHeight : maxHeight * Math.Pow(2, 10 * (currentTime / duration - 1)) + minHeight;
        }
        ...
        {
            if (Math.Abs(currentTime) < double.Epsilon)
                return minHeight;

            if (Math.Abs(currentTime - duration) < double.Epsilon)
        ...
        {
            if (Math.Abs((currentTime /= duration) - 1) < double.Epsilon)
                return minHeight + maxHeight;
        ...
        {
            if (Math.Abs((currentTime /= duration / 2) - 2) < double.Epsilon)
                return minHeight + maxHeight;
